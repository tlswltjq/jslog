...
public class MemberController {
    ...
    @DeleteMapping
    public ApiResponse<WithdrawResponse> withdraw(@AuthenticationPrincipal AuthUserDetails authUser) {
        Long memberId = authUser.getAccountId();
        withdraw.invoke(memberId);
        return ApiResponse.success(HttpStatus.OK.value(), "회원 탈퇴 성공", WithdrawResponse.from(memberId));
    }

    @GetMapping("/me")
    public ApiResponse<MemberResponse> getMemberInfo(@AuthenticationPrincipal AuthUserDetails authUser) {
        Long memberId = authUser.getAccountId();
    ...
    public ApiResponse<ChangeNicknameResponse> changeNickname(@AuthenticationPrincipal AuthUserDetails authUser,
    ...
    public ApiResponse<EditProfileResponse> editProfile(@AuthenticationPrincipal AuthUserDetails authUser, @RequestBody EditProfileRequest request) {
        Long memberId = authUser.getAccountId();
